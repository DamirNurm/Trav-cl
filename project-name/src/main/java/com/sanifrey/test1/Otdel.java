...
public class Otdel {
	...
	/**
	 * Объявляем кнопки.
	 * button_save - Кнопка для сохранения результатов.
	...
	/**
	 * Объявляем поля ввода JTextField. 
	 * textField_AllArea - Поле для вывода значения всей площади комнаты. 
	 * textField_FreeArea - Поле для вывода значения свободной площади.
	 */
	...
	private void UpdateTextFields() {
		/**
		 * Заполняем поле textField_AllArea в окне "Отделочник" получая значения через геттер
		 * getAllArea()
		 */
		setTextField(0,String.valueOf(Formula.getAllArea()));
		/**
		 * Заполняем поле textField_FreeArea в окне "Отделочник" получая значения через геттер
		 * getFreeArea()
		 */
