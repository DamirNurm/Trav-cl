...
*/ 
 formula = new Formula();
 /** 
 * Тестируем метод с входными параметрами 70, 5, 4 и с предполагаемым результатом 50 для проверки работы программы с дробными числами.
 ...
 * Предполагается, что программа выполнит следующие расчёты: 70-5*4 и
 * вернёт значение: 50.0.
 */  formula.PublicAddObject( "5", "4");
assertEquals("50.0",formula.PFormula("70"));
