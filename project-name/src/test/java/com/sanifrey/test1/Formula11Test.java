...
*/ 
 formula = new Formula();
 /** 
 * Тестируем метод с входными параметрами 100, 8, 3 и с предполагаемым результатом 50 для проверки работы программы с дробными числами.
 ...
 * Предполагается, что программа выполнит следующие расчёты: 100-8*3 и
 * вернёт значение: 76.0.
 */  formula.PublicAddObject( "8", "3");
assertEquals("76.0",formula.PFormula("100"));
