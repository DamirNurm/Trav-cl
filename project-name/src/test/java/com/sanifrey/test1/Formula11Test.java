...
*/ 
 formula = new Formula();
 /** 
 * Тестируем метод с входными параметрами 65, 7, 3 и с предполагаемым результатом 44 для проверки работы программы с дробными числами.
 ...
 * Предполагается, что программа выполнит следующие расчёты: 65-7*3 и
 * вернёт значение: 44.0
 */  formula.PublicAddObject( "7", "3");
assertEquals("44.0",formula.PFormula("65"));
