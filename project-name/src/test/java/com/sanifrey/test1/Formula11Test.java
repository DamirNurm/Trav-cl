...
*/ 
 formula = new Formula();
 /** 
 * Тестируем метод с входными параметрами 60, 5, 4 и с предполагаемым результатом 40 для проверки работы программы с дробными числами.
 ...
 * Предполагается, что программа выполнит следующие расчёты: 60-5*4 и
 * вернёт значение: 40.
 */  formula.PublicAddObject( "5", "4");
assertEquals("40.0",formula.PFormula("60"));
