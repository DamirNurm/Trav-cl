...
public class Formula13Test {
	...
	public void testFormula1() {
		 ...
		 */
		/**
		 * Тестируем метод с входными параметрами 100, 5, 6 и с предполагаемым
		 * результатом 70.0 для проверки работы программы с целыми числами. Тестируемый
		 ...
		 * 100-5*6 и вернёт значение: 70.0.
		 */
		formula.PublicAddObject("5", "6");
		assertEquals("70.0", formula.PFormula("100"));
