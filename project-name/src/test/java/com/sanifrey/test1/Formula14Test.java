...
public class Formula14Test {
	...
	public void test() {
		...
		formula = new Formula();
		/**
		 * Тестируем метод с входными параметрами 70, 3, 5 и с предполагаемым
		 * результатом 55.0 для проверки работы программы с целыми числами. Тестируемый
		 ...
		 * 70-3*5 и вернёт значение: 55.0.
		 */
		formula.PublicAddObject("3", "5");
		assertEquals("55.0", formula.PFormula("70"));
