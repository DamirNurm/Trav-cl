...
public class Formula14Test {
	...
	@Test
		 /** 
 * Тестируем метод с входными параметрами 17, 2, 8 и с предполагаемым результатом 1.0 для проверки работы программы с дробными числами.
 ...
 * Предполагается, что программа выполнит следующие расчёты: 17-2*8 и
 * вернёт значение: 1.0.
 */
	public void testFormula1() {
		/**
		 * Добавляем объект для расчётов при помощи метода PublicAddObject со значением ширины "2" и значением длины "8".
		 */
		formula.PublicAddObject( "2", "8");
		/**
