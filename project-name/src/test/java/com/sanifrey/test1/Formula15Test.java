...
*/ 
 formula = new Formula();
 /** 
 * Тестируем метод с входными параметрами 80, 5, 7 и с предполагаемым результатом 45.0 для проверки работы программы с дробными числами.
 ...
 * Предполагается, что программа выполнит следующие расчёты: 80-5*7 и
 * вернёт значение: 45.0
 */ formula.PublicAddObject("5", "7");
assertEquals("45.0",formula.PFormula("80"));
